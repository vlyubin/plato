...
from credentials import OPENAI_KEY, ELEVENLABS_KEY, ACCESS_CODE
...
def judge_speech(debate_id):
    ...
    full_judgement_text = generate_judgement_audio(debate_id, score1, score2, debate_instance["speaker1"], debate_instance["speaker2"], judge_speech[:120])
